...
public class TodoControllerJpa {
    ...
    @GetMapping("/todolist")
    public String Todo( ModelMap model,Principal principal) {
        String username=principal.getName();
        List<TodoClass> todos = todoRepository.findByUsername(username);
...
model.addAttribute("todos",new TodoClass());
        return "addTodo";
    }

    @PostMapping("/saveTodo")
    public String postaddTodo(@ModelAttribute("todos") TodoClass todos, BindingResult bindingResult, Principal principal)
    {
